...
const SubmitProfileBanner = ({isOpen, onClose, onSubmit}) => {
    ...
    return (
        <div className="modal">
            <div className="modal-content link">
                ...
                <h2>Enter Link</h2>
                <p>Enter a link to a picture on the internet to set as your profile banner.</p>
...
export default SubmitProfileBanner;